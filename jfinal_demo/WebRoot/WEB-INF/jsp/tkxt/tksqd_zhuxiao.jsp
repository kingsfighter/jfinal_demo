...
<body>
	<div style="width:90%">
		<form id="fm" method="post" name="fm" action="zhuxiao">
			<table cellpadding="5">
				<tr>
				...
				<tr>
	    			<td>注销类型:</td>
	    			<td><input class="easyui-textbox" type="text" name="tksqd.zxlx"  data-options="required:true"></input></td>
	    			<td>有效期:</td>
	    			<td><input class="easyui-textbox" type="text" name="tksqd.yxq"  data-options="required:true"></input></td>
	    			<td>勘察使用费累计缴纳:</td>
	    			<td><input class="easyui-textbox" type="text" name="tksqd.kcsyfljjn"  data-options="required:true"></input></td>
	    		</tr>
	    		<tr>
	    			<td>注销理由:</td>
	    			<td colspan=5><textarea rows="10" cols="50" name="tksqd.zxly"></textarea></td>
	    		</tr>
	    		<tr>
	    			<td>登记机关管理意见:</td>
	    			<td colspan=5><textarea rows="10" cols="50" name="tksqd.djjgglyj"></textarea></td>
	    		</tr>
	    	</table>
		</form>
